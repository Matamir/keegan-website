    ...
    return (
        <div className="navbar navBarCustom">
            ...
            <div className='d-flex justify-content-center'>
                <input type="text" className = "searchBar" placeholder='Search Here' onKeyDown={(e) => {if(e.key == 'Enter') {let linkSearch = '../' + e.currentTarget.value.toString(); window.location=linkSearch}}}></input>
            </div>
